...
joined_table %>%
  ...
  ggtitle("Gene Expression Levels in Different Cancer Stages and Tissue Types") +
...
joined_table %>%
  ...
  xlab("Smoking Status") +
  ylab("Mean Expression Level") +
  ggtitle("Expression Levels of SFTPC Gene in Different Cancer Stages and Smoking Status") +
  facet_grid(~ normal_or_cancer) +
   theme_bw() +
   theme(axis.text.x = element_text(angle = 90,
                         hjust = 1))
...
joined_table %>%
  ...
  ylab("Mean Expression Level") +
  ggtitle("Association of SFTPC Gene Expression Levels with Age and Smoking Status") +
  geom_point() +
   theme_bw() +
...
joined_table %>%
  ...
  ggplot(aes(x = age_at_diagnosis,
   ...
   xlab("Age at Diagnosis") +
  ylab("Mean Expression Level") +
  ggtitle("Association of SFTPC Gene Expression Levels with Age and Smoking Status in Different Genders") +
  geom_point() +
   theme_bw() +
   geom_smooth(method = "lm",
              alpha = 0) +
