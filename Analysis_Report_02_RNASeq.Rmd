...
```{r make-histogram-of-highly-expressed-genes, echo = FALSE}
...
```{r histogram-of-SFTPC-expression-levels}
...
```{r scatteredplot-of-SFTPC-expression-smoking-age}
...
```{r scatteredplot-of-SFTPC-gene-expression-gender-age}
...
```{r histogram-of-sample-dsitribution}
